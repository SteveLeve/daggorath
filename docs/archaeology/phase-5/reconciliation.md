...
| A power-on to `WINNER` playthrough script | not yet authored. A prepared hold of the level-4 supreme ring plus `INCANT FINAL` does reach `WINNER`. The ring is carried by creature type 11 (power 8000, physical defense 0, magic defense 6). At power 160 a wooden sword deals 0, an elvish sword deals 3, and the fire ring deals 14. The fire ring's exertion is large enough that the player cannot swing it repeatedly at that power. |
