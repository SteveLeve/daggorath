...
| [`rendering-and-audio.md`](rendering-and-audio.md) | core events, sound selection and volume, `SNOISE` | 6a: Core events and Sound sections; viewer geometry still Phase 6 |
