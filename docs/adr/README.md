...
| [0004](0004-presentation-contract.md) | Presentation contract: render state and ordered events | Proposed | core events: Phase 6a (before Phase 3); projection: Phase 6 |
